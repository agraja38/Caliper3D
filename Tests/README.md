...
The security checkpoint adds ephemeral Security identity validation, pairing/commitment/pin/forget tests, and two real Network.framework TLS loopback tests bound only to 127.0.0.1. They do not advertise Bonjour or access the user's identities/captures. Keychain persistence still requires signed-app runtime verification.
